...
import { removeFromBasket, increaseQuantity, decreaseQuantity } from '@/lib/cocktail/cocktailSlice';
    ...
    <div>
      <div className="flex justify-center">
        <div className="relative" ref={dropdownRef}>
          ...
          {isOpen && (
            <div className="absolute w-full mt-2 rounded-b border-t-0 z-10 bg-white shadow-xl">
              <div className="w-64">
                {basketItems.length > 0 ? (
                      ...
                      <div className="flex-auto text-sm w-32">
                        ...
                        <div className="flex items-center justify-between mt-2">
                          <div className="flex items-center space-x-2 text-gray-400">
                            <button onClick={() => handleDecreaseQuantity(item)} className="text-red-500 hover:text-red-700">
                              -
                            </button>
                            <span>{item.quantity}</span>
                            <button onClick={() => handleIncreaseQuantity(item)} className="text-green-500 hover:text-green-700">
                              +
                            </button>
                          </div>
                          <div
                  ...
                  <p className="text-gray-600 text-sm p-4 bg-white">Your cart is empty</p>
                )}
